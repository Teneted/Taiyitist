...
public class MixinCrossbowItem {
    ...
    private static final AtomicBoolean taiyitist$capturedBoolean = new AtomicBoolean(true);
    ...
    private void taiyitist$entityShoot(LivingEntity livingEntity, Projectile projectile, int i, float f, float g, float h, LivingEntity livingEntity2, CallbackInfo ci) {
    ...
    private static boolean taiyitist$addEntity(Level world, Entity entityIn, CallbackInfo ci, Level worldIn, LivingEntity shooter) {

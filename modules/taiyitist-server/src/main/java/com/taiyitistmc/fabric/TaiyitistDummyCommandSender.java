...
import com.taiyitistmc.fabric.permission.TaiyitistDummyPermissible;
...
public class TaiyitistDummyCommandSender extends TaiyitistDummyPermissible implements CommandSender {

    public CommandSourceStack stack;
    public Spigot spigot;

    public TaiyitistDummyCommandSender(CommandSourceStack stack) {
        this.stack = stack;
    }
    ...
    public class Spigot extends CommandSender.Spigot {
        ...
        public void sendMessage(@NotNull BaseComponent component) {
            ...
            var result = CraftChatMessage.ChatSerializer.fromJson(String.valueOf(json), stack.getServer().registryAccess());
            if (result != null) {

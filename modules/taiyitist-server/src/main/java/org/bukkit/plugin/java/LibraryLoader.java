...
import org.teneted.taiyitist.bukkit.PluginsLibrarySource;
import org.teneted.taiyitist.bukkit.remapping.generated.RemappingURLClassLoader;
...
class LibraryLoader {
    ...
    public ClassLoader createLoader(@NotNull PluginDescriptionFile desc) throws IOException {
        ...
        TaiyitistMCStart.LOGGER.info(I18n.as("spigot.lib.loading"), desc.getName(), desc.getLibraries().size());
        ...
        TaiyitistMCStart.LOGGER.info(I18n.as("spigot.lib.loading.extra"), desc.getName(), newDependencies.size() - desc.getLibraries().size());
        ...
        for (Dependency dependency : newDependencies) {
            ...
            try {
                ...
                TaiyitistMCStart.LOGGER.error(e.getMessage());
            }
        }
        ...
        for (File file : libraries) {
            try {
                ...
                TaiyitistMCStart.LOGGER.info(I18n.as("spigot.lib.loaded"), desc.getName(), file);

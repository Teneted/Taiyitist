...
public class CraftFishHook extends CraftProjectile implements FishHook {
   ...
   public double getBiteChance() {
      ...
      if (this.biteChance == -1.0) {
         return hook.level().isRainingAt(BlockPos.containing(hook.position()).offset(0, 1, 0)) ? 0.0033333333333333335 : 0.002;
      } else {
   ...
   public void setBiteChance(double chance) {
      Preconditions.checkArgument(chance >= 0.0 && chance <= 1.0, "The bite chance must be between 0 and 1");

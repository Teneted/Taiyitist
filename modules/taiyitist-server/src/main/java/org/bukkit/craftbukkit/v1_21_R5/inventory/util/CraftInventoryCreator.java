...
public final class CraftInventoryCreator {
   ...
   public Inventory createInventory(InventoryHolder holder, InventoryType type) {
      return ((InventoryConverter)this.converterMap.get(type)).createInventory(holder, type);
   }

   public Inventory createInventory(InventoryHolder holder, InventoryType type, String title) {
      return ((InventoryConverter)this.converterMap.get(type)).createInventory(holder, type, title);
   }

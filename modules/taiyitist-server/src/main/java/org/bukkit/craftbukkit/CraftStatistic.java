...
public enum CraftStatistic {
   ...
   public static Stat getNMSStatistic(Statistic bukkit) {
      ...
      Stat<ResourceLocation> nms = Stats.CUSTOM.get((ResourceLocation)statistics.inverse().get(bukkit));
   ...
   public static Stat getEntityStatistic(Statistic stat, EntityType entity) {
   ...
   public static EntityType getEntityTypeFromStatistic(Stat<net.minecraft.world.entity.EntityType<?>> statistic) {
      Preconditions.checkArgument(statistic != null, "NMS Statistic cannot be null");
      return CraftEntityType.minecraftToBukkit((net.minecraft.world.entity.EntityType)statistic.getValue());
   }

   public static Material getMaterialFromStatistic(Stat<?> statistic) {
      Object var2 = statistic.getValue();
      if (var2 instanceof Item statisticItemValue) {
         return CraftItemType.minecraftToBukkit(statisticItemValue);
      } else {
         var2 = statistic.getValue();
         if (var2 instanceof Block statisticBlockValue) {
   ...
   public static void setStatistic(ServerStatsCounter manager, Statistic statistic, int newValue, ServerPlayer player) {
      ...
      manager.setValue((Player)null, nmsStatistic, newValue);
      if (player != null) {
   ...
   public static void incrementStatistic(ServerStatsCounter manager, Statistic statistic, Material material, ServerPlayer player) {
      incrementStatistic(manager, statistic, (Material)material, 1, player);
   }
   ...
   public static void decrementStatistic(ServerStatsCounter manager, Statistic statistic, Material material, ServerPlayer player) {
      decrementStatistic(manager, statistic, (Material)material, 1, player);
   }
   ...
   public static int getStatistic(ServerStatsCounter manager, Statistic statistic, Material material) {
      ...
      Stat nmsStatistic = getMaterialStatistic(statistic, material);
   ...
   public static void incrementStatistic(ServerStatsCounter manager, Statistic statistic, EntityType entityType, ServerPlayer player) {
      incrementStatistic(manager, statistic, (EntityType)entityType, 1, player);
   }
   ...
   public static void decrementStatistic(ServerStatsCounter manager, Statistic statistic, EntityType entityType, ServerPlayer player) {
      decrementStatistic(manager, statistic, (EntityType)entityType, 1, player);
   }
   ...
   public static int getStatistic(ServerStatsCounter manager, Statistic statistic, EntityType entityType) {
      ...
      Stat nmsStatistic = getEntityStatistic(statistic, entityType);

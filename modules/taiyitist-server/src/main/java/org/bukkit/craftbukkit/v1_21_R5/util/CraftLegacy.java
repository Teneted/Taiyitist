...
public final class CraftLegacy {
   ...
   public static Material fromLegacy(Material material) {
      return material != null && material.isLegacy() ? org.bukkit.craftbukkit.v1_21_R5.legacy.CraftLegacy.fromLegacy(material) : material;
   }

   public static Material fromLegacy(MaterialData materialData) {
      return org.bukkit.craftbukkit.v1_21_R5.legacy.CraftLegacy.fromLegacy(materialData);
   }

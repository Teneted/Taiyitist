   ...
   public <T extends Projectile> T launchProjectile(Class<? extends T> projectile, Vector velocity) {
      ...
      if (Fireball.class.isAssignableFrom(projectile)) {
         ...
         if (WitherSkull.class.isAssignableFrom(projectile)) {
            launch = customFireball = (AbstractHurtingProjectile)EntityType.WITHER_SKULL.create(world, EntitySpawnReason.TRIGGERED);
         } else if (DragonFireball.class.isAssignableFrom(projectile)) {
            launch = (net.minecraft.world.entity.projectile.Projectile)EntityType.DRAGON_FIREBALL.create(world, EntitySpawnReason.TRIGGERED);
         } else if (BreezeWindCharge.class.isAssignableFrom(projectile)) {
            launch = customFireball = (AbstractHurtingProjectile)EntityType.BREEZE_WIND_CHARGE.create(world, EntitySpawnReason.TRIGGERED);
         } else if (LargeFireball.class.isAssignableFrom(projectile)) {
            launch = customFireball = (AbstractHurtingProjectile)EntityType.FIREBALL.create(world, EntitySpawnReason.TRIGGERED);
         }
         ...
         if (customFireball != null) {
            ...
            customFireball.assignDirectionalMovement(vec3d, 0.1);
         }
      }
      ...
      ((net.minecraft.world.entity.projectile.Projectile)launch).projectileSource = this;
      ...
      return (Projectile)((net.minecraft.world.entity.projectile.Projectile)launch).getBukkitEntity();
   }
}

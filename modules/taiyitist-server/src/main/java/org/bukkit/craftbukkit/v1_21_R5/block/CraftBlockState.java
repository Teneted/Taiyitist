...
public class CraftBlockState implements BlockState {
   ...
   public Location getLocation() {
      return CraftLocation.toBukkit((BlockPos)this.position, (World)this.world);
   }
   ...
   public boolean equals(Object obj) {
      if (obj == null) {
         ...
         if (this.world != other.world && (this.world == null || !this.world.equals(other.world))) {
            return false;
         } else if (this.position == other.position || this.position != null && this.position.equals(other.position)) {

...
public class CraftAccessLocationInventoryViewBuilder<V extends InventoryView> extends CraftAbstractLocationInventoryViewBuilder<V> {
   ...
   public CraftAccessLocationInventoryViewBuilder(MenuType<?> handle, CraftAccessContainerObjectBuilder containerBuilder) {
      super(handle);
   ...
   public interface CraftAccessContainerObjectBuilder {
      AbstractContainerMenu build(int var1, Inventory var2, ContainerLevelAccess var3);
   }
}

...
public class CraftBlockProjectileSource implements BlockProjectileSource {
    ...
    public <T extends Projectile> T launchProjectile(Class<? extends T> projectile, Vector velocity) {
        ...
        if (Snowball.class.isAssignableFrom(projectile)) {
            ...
            ((net.minecraft.world.entity.projectile.AbstractArrow) launch).taiyitist$setProjectileSource(this);
        ...
        if (launch instanceof net.minecraft.world.entity.projectile.Projectile) {
            if (launch instanceof net.minecraft.world.entity.projectile.ThrowableProjectile) {
                ((net.minecraft.world.entity.projectile.ThrowableProjectile) launch).taiyitist$setProjectileSource(this);
            }

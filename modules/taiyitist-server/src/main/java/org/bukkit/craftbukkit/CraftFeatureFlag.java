...
public class CraftFeatureFlag implements FeatureFlag {
   ...
   public String toString() {
      ...
      return "CraftFeatureFlag{key=" + var10000 + ",keyUniverse=" + this.getHandle().universe.toString() + "}";
   }
   ...
   public static CraftFeatureFlag getFromNMS(NamespacedKey namespacedKey) {
      return (CraftFeatureFlag)FeatureFlags.REGISTRY.names.entrySet().stream().filter((entry) -> {

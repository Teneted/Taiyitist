package org.celestial_artistry.taiyitist.bukkit;
...
public enum PluginsLibrarySource {
    ...
    public static boolean isCN() {
        return TaiyitistMCStart.I18N.isCN() && ConnectionUtil.measureLatency(ALIBABA.url) < ConnectionUtil.measureLatency(MAVEN2.url);
    }
}

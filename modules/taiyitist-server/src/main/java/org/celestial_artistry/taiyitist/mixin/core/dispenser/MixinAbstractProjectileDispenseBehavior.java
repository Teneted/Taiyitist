package org.celestial_artistry.taiyitist.mixin.core.dispenser;
...
public abstract class MixinAbstractProjectileDispenseBehavior {
    ...
    public ItemStack execute(BlockSource isourceblock, ItemStack stack) {
        ...
        projectile.taiyitist$setProjectileSource(new CraftBlockProjectileSource((DispenserBlockEntity) isourceblock.getEntity()));

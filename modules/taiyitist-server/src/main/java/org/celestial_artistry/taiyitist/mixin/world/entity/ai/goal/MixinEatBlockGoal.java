package org.celestial_artistry.taiyitist.mixin.world.entity.ai.goal;
...
public abstract class MixinEatBlockGoal extends Goal {
    ...
    private boolean taiyitist$eatGrassTick(GameRules instance, GameRules.Key<GameRules.BooleanValue> key) {

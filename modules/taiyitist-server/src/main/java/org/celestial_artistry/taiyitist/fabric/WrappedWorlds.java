package org.celestial_artistry.taiyitist.fabric;
            ...
            return getOrCreate(cl, key -> {
                for (Field f : cl.getDeclaredFields()) {
                    if (Level.class.isAssignableFrom(f.getType())) {
                        TaiyitistMod.LOGGER.debug("{} delegates to field {}", cl, f.getName());
                ...
                if (delegate.isPresent()) {
                    ...
                    TaiyitistMod.LOGGER.debug("{} delegates to nothing", cl);
                    return null;
                }
            });
        }

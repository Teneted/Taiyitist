...
public abstract class MixinConduitBlockEntity {
    ...
    @Shadow
    @Nullable
    private static EntityReference<LivingEntity> updateDestroyTarget(@Nullable EntityReference<LivingEntity> target, ServerLevel level, BlockPos pos, boolean isActive) {
        return null;
    }

...
import org.teneted.taiyitist.bukkit.BukkitDispatcher;
...
public abstract class MixinCommands implements InjectionCommands {
    ...
    @Shadow
    public abstract void performCommand(ParseResults<CommandSourceStack> command, String commandString);

    @Shadow
    public abstract void performPrefixedCommand(CommandSourceStack sender, String command);

...
public class CraftMerchantRecipe extends MerchantRecipe {
    ...
    public net.minecraft.world.item.trading.MerchantOffer toMinecraft() {
        ...
        handle.baseCostA = new ItemCost(baseCostA.typeHolder(), baseCostA.getCount(), baseCostAPredicate, baseCostA);
        if (ingredients.size() > 1) {
            ...
            handle.costB = Optional.of(new ItemCost(costB.typeHolder(), costB.getCount(), costBPredicate, costB));
        } else {

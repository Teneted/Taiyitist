...
public class TaiyitistLauncher {
    ...
    public static void main(String[] args) throws Throwable {
        ...
        if (javaVersion < MIN_CLASS_VERSION) {
            System.err.println("Taiyitist requires Java " + MIN_JAVA_VERSION);
        ...
        if (javaVersion > MAX_CLASS_VERSION) {
            System.err.println("Warning: Taiyitist is known to be compatible with up to Java " + MAX_JAVA_VERSION + " and may not run on later versions");
            System.err.println("Current: " + System.getProperty("java.version"));
            System.err.flush();
            Thread.sleep(3000);
        }

        try (InputStream input = TaiyitistLauncher.class.getResourceAsStream("/taiyitist-server-launch.properties")) {
